...
export default function Category() {
  ...
  const subcategories = useMemo(() => {
    ...
    const subs = new Set(categoryLocations.map(loc => loc.subcategory).filter(Boolean));
  ...
  const hasActiveFilters = priceFilter.length > 0 || statusFilter !== "all" || subcategoryFilter !== "all" || cuisineFilter !== "all" || searchQuery;
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  <div>
                    ...
                    <div className="flex flex-col gap-2">
                      <Button
                        variant={priceFilter.includes("low") ? "default" : "outline"}
                        size="sm"
                      ...
                      <Button
                        variant={priceFilter.includes("medium") ? "default" : "outline"}
                        size="sm"
                      ...
                      <Button
                        variant={priceFilter.includes("high") ? "default" : "outline"}
                        size="sm"
                  ...
                  {subcategories.length > 0 && (
                    <div>
                      <h4 className="mb-3 text-sm font-semibold">Subcategory</h4>
                      <select
                      ...
                      <div className="absolute top-4 right-4 z-10">
                        ...
                        >
                          <span className="relative flex h-2.5 w-2.5">
                            ...
                            <span className={`relative inline-flex h-2.5 w-2.5 rounded-full ${vendor.isOpen ? "bg-white" : "bg-white/60"}`} />
                          </span>
                      ...
                      <div className="absolute inset-0 flex flex-col justify-between p-6">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-start gap-3 bg-black/60 backdrop-blur-md p-3 rounded-xl border border-white/20">
                            ...
                            <span className="text-sm font-bold text-white">{vendor.eventLocation}</span>
                          </div>
                          <div className="flex items-start gap-3 bg-black/60 backdrop-blur-md p-3 rounded-xl border border-white/20">
                            <Clock className="h-5 w-5 text-white mt-0.5 flex-shrink-0" />
                            <span className="text-sm font-bold text-white">{vendor.eventTime}</span>
                          </div>
                        </div>
                      </div>
                    </div>
