...
const mockReviews = [
  {
    ...
    date: '2 days ago',
    comment:
      'Amazing burgers! The chargrilled flavor is perfection and the ingredients are always fresh.',
  ...
  },
  {
    ...
    date: '1 week ago',
    comment:
      'Great spot for a quick lunch between classes. The atmosphere is casual and welcoming.',
  ...
  },
  {
    ...
    date: '2 weeks ago',
    comment:
      'The daily specials are always creative and delicious. Best value on campus!',
  ...
  },
  {
    ...
    date: '3 weeks ago',
    comment:
      'Solid American fare with generous portions. The staff is always friendly.',
...
const outpostMenuItems: Record<string, MenuItem[]> = {
  ...
  Bowls: [
    {
      ...
      price: '$10.49',
      description:
        'Charbroiled chicken, avocado, brown rice, black beans, lettuce, cucumber, pepper jack cheese, chipotle ranch, pico de gallo. Contains eggs, milk, and soy',
    },
    {
      name: 'Chicken Pesto Bowl',
      price: '$8.29',
      description:
        'Charbroiled chicken, brown rice and zucchini with creamy pesto sauce. Contains eggs, milk, and soy',
    },
    {
      name: 'Carnitas Bowl',
      price: '$9.99',
      description:
        'Carnitas, avocado, cilantro lime rice, pinto beans, pico de gallo, and cheddar cheese with corn tortilla chips. Contains milk, soy, and wheat',
    },
    {
      name: 'Chicken Teriyaki Bowl',
      price: '$8.49',
      description:
        'Charbroiled teriyaki glazed chicken, white rice, green onion, and cabbage. Contains soy and wheat',
    },
    {
      name: 'Falafel & Rice Bowl',
      price: '$8.49',
      description:
        'Brown rice, green chickpea falafel with tzatziki sauce, herb vinaigrette, feta cheese, lettuce, tomato, red onion and cucumber, served with pita bread. Contains milk, soy, wheat, and sesame seeds',
    },
    {
      name: 'Butter Chicken Bowl',
      price: '$8.79',
      description:
        'Chicken breast, rice, butter sauce, served with naan bread. Contains eggs, milk, wheat, and soy',
    },
    {
      name: 'Beach Bowl',
      price: '$6.69',
      description:
        'Roasted deli turkey, brown rice, black beans, cucumber, pico de gallo, and herb vinaigrette. Contains soy',
    },
  ],
  Salads: [
    {
    ...
    },
    {
      ...
      price: '$10.49',
      description:
        'Charbroiled chicken breast, lettuce, shredded carrots, crispy noodles, cucumber, green onion and sesame vinaigrette dressing. Contains soy and sesame seeds',
    },
    {
  ...
  Sandwiches: [
    ...
    },
    {
      ...
      price: '$7.99',
      description:
        'Green chickpea falafel with tzatziki sauce, herb vinaigrette, feta cheese, lettuce, tomato, red onion and cucumber. Contains milk, soy, wheat, and sesame seeds',
    },
    {
  ...
  'Appetizers & Fries': [
    {
      ...
      price: '$8.49',
      description:
        'Charbroiled chicken breast, pepper jack cheese, sour cream & salsa. Contains milk, soy, and wheat',
    },
    {
      name: 'Carnitas Quesadilla',
      price: '$8.49',
      description:
        'Roasted pork carnitas, pepper jack cheese, sour cream & salsa. Contains milk, soy, and wheat',
    },
    {
  ...
  Beverages: [
    {
      name: 'Fountain Drinks (24 oz)',
      price: '$3.09',
      description: 'Coke, Sprite, Dr. Pepper, and more',
    },
    {
      name: 'Fountain Drinks (32 oz)',
      price: '$3.29',
      description: 'Coke, Sprite, Dr. Pepper, and more',
    },
    {
      name: 'Coffee (12 oz)',
      price: '$3.09',
      description: 'Proudly serving Starbucks coffee',
    },
    {
      name: 'Coffee (16 oz)',
      price: '$3.29',
    ...
    },
    {
      ...
      price: '$4.45',
      description: 'Starbucks Cold-Brew',
    },
    {
      name: 'Cafe 57 (12 oz)',
      price: '$3.09',
  ...
  'Signature Items': [
    {
      ...
      price: 'Varies',
      description:
        'Customize your smoothie with your choice of proteins, fruits, and boosters',
    },
    {
      name: 'Acai Bowl',
      price: 'Varies',
      description:
        'Fresh acai topped with granola, banana, and your choice of toppings',
    },
    {
      name: 'Protein Shake',
      price: 'Varies',
      description: 'High-protein shakes perfect for post-workout recovery',
    },
  ],
};
      ...
      <div className="relative h-[400px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 pb-8">
          <div className="container px-4">
            <Link
              to={`/category/${location.category.toLowerCase().replace(/\s+/g, '-')}`}
            >
              <Button
                variant="ghost"
                size="sm"
                className="mb-4 gap-2 text-white/90 hover:text-white hover:bg-white/10"
              >
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                <span
                  className={`h-2 w-2 rounded-full ${isOpen ? 'bg-white' : 'bg-muted-foreground'}`}
                />
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-lg ${isOpen ? 'bg-success/10' : 'bg-muted'}`}
                  >
                    <Clock
                      className={`h-5 w-5 ${isOpen ? 'text-success' : 'text-muted-foreground'}`}
                    />
                  </div>
                  <div className="flex-1">
                    <p className="text-xs text-muted-foreground">Status</p>
                    <p
                      className={`font-semibold ${isOpen ? 'text-success' : 'text-muted-foreground'}`}
                    >
                      {isOpen ? 'Open Now' : 'Closed'}
                    </p>
                  </div>
                ...
                <div className="space-y-1">
                  {Object.entries(location.hours).map(([day, hours]) => (
                    ...
                    >
                      ...
                      <span
                        className={`font-medium ${hours !== 'Closed' ? 'text-foreground' : 'text-muted-foreground'}`}
                      >
                        {hours}
                      </span>
                    </div>
