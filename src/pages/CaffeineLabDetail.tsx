...
const photoSections = [
  {
    ...
    photos: [
      ...
      {
        url: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=800&h=600&fit=crop',
        caption: 'Energy Drinks',
      },
      {
        url: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800&h=600&fit=crop',
        caption: 'Iced Beverages',
      },
    ],
  },
  {
    ...
    photos: [
      {
        ...
        caption: 'Quick Snacks',
      },
      {
        url: 'https://images.unsplash.com/photo-1601924582970-9238bcb495d9?w=800&h=600&fit=crop',
        caption: 'Drinks & More',
      },
      {
      ...
      <div className="relative h-[400px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 pb-8">
          <div className="container px-4">
            ...
            <h1 className="mb-3 text-5xl font-bold text-white">Caffeine Lab</h1>
          ...
          <main className="space-y-8">
            ...
            <section className="rounded-xl border border-border bg-gradient-to-br from-card to-card/50 p-8 shadow-card">
              ...
              <p className="text-muted-foreground leading-relaxed text-base">
                Specialty coffee and energy drinks in a modern setting. Perfect
                spot for studying or grabbing a quick caffeine boost between
                classes. We also have a convenience store with snacks, drinks,
                and campus essentials.
              </p>
            </section>
