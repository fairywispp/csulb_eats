      ...
      <div className="container px-4 py-8">
        ...
        <div className="mt-8 rounded-lg border border-border bg-accent/10 p-6">
          ...
          <p className="text-muted-foreground">
            Dining hall hours are subject to change during university breaks and
            holidays. Please check back here or contact dining services for
            updated schedules during these periods.
          </p>
        </div>
      </div>
    </div>
